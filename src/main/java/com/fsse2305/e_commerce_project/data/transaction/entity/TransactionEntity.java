package com.fsse2305.e_commerce_project.data.transaction.entity;
...
public class TransactionEntity {
    ...
    public TransactionEntity(UserEntity userEntity, List<CartItemEntity> cartItemEntityList) {
    ...
    public void setTotal(TransactionProductEntity transactionProductEntity) {
        this.total = this.total.add(transactionProductEntity.getSubtotal());
    }
